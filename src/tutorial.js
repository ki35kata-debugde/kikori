...
const TUTORIAL_STEPS={
  ...
  aim:{
    ...
    body:`地面の<g>緑の帯</g>が、倒したい方角。<br>
      ...
      <p class="tu-note">二つを重ねてから伐れば<b>倒す精度</b>が上がり、<b>売値も上がる</b>。</p>`
  },
  cut:{
    label:'③　斧で二か所を切る',
    ...
    body:`<table class="tu-tbl">
      ...
      <g>緑の破線</g>まで来たら止める。切りすぎると舵を失う。<br>
      受け口は倒す側へクサビ形に切り、斜めと水平を同じ深さで揃える。深さは直径の22〜35%。
      開きが狭すぎると途中で閉じ、ツルが折れて舵を失う。<br>
      追い口は反対側から水平に切り込む。受け口の床より+2〜+5cmが適正。
      低すぎると幹が手前へ蹴り返す。</p>`
  },
  result:{
    label:'結果',
  ...
  evening:{
    ...
    body:`<table class="tu-tbl">
      ...
      枝打ちと道の手入れを選ぶと、余った体力はその日限りで消える。<br><br>
      <b>手入れ度が高い林ほど、まっすぐで節の少ない上等な木が育ちやすい。</b>
      ただし人が手を入れなければ、全ての林で毎朝ひとつずつ下がる。</p>`
  },
  night:{
    label:'夜　—　家',
